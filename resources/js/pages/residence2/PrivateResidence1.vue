        ...
        <div class="flex flex-col min-[1025px]:flex-row items-center justify-center min-h-screen px-0 lg:px-6 py-8 gap-0 lg:gap-4">
            ...
            <div class="flex flex-col items-center md:items-start pl-0 md:pl-8 lg:pl-12">
                ...
                <div class="residence-image-appear w-full md:w-auto flex justify-center">
                        <img src="../../images/primagessss.jpg" alt="Private residence studio unit floor plan"
                            width="429" height="619" loading="lazy" decoding="async"
